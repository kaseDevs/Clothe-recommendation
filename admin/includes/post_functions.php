...
function getAllPosts()
{
	...
	} elseif ($_SESSION['user']['role'] == "Aurthor") {
...
function createPost($request_values)
	{
		...
		if (count($errors) == 0) {
			$query = "INSERT INTO posts (user_id, title, slug, image, body, published, created_at) VALUES(1, '$title', '$post_slug', '$featured_image', '$body', $published, now())";
